            ...
            <table class="table table-bordered">
                ...
                <c:forEach items="${pageable.content}" var="item">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/admin/user/delete/${pageable.number}/${item.id}"
                               class="btn btn-danger"
                               onclick="if (!(confirm('Vous Voulez supprimer cet element ?'))) return false">
                               Supprimer
                            </a>
                            <a href="${pageContext.request.contextPath}/admin/user/add/${item.id}"
